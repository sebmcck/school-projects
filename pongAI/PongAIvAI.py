...
sys.path.append(os.path.dirname("/Users/sebastienmk/uni/cs/PongvPongAI.py"))  # add this script’s directory
...
os.chdir("/Users/sebastienmk/uni/cs")
...
def init_game():
    ...
    import chaser_ai
    import prediction_ai
###
    paddles[0].move_getter = chaser_ai.pong_ai
    paddles[1].move_getter = prediction_ai.best_ai
